...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('js/beer.js') }}"></script>
    ...
    <body class="antialiased">
        <div class="container">
            <div class= "row justify-content-center">
                <div class="col-6 mt-3" id="loginContainer">
                    <form id="loginForm">
            ...
            <div id="beerListContainer" style ="display:none" class="mt-3">
                <div class="row justify-content-center">
                    <div class="col-auto">
                ...
                <div class="row mt-3 justify-content-center">
                    <ul class="list-group col-6" id="beerList">
                    </ul>
                </div>
                <div class="row mt-3 justify-content-center">
                    <x-alert/>
                ...
                <div class="row justify-content-center">
                    <div class="col-auto mt-3">
                        <label id="pageCounter">Page 1</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <nav aria-label="Page navigation example" class="col align-self-center mt-3">
        ...
        <script>
            var urlLogout = "{{route('api.logout')}}";
            var urlLogin = "{{route('api.login')}}";
            var urlBeers = "{{route('api.getBeers')}}";
            var urlCheckToken = "{{route('api.check-token')}}";
        </script>
    </body>
</html>
